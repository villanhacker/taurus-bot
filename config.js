...
module.exports = {
    ...
    AFNN: process.env.TAG_REPLY === undefined ? '919961050829@s.whatsapp.net' : process.env.TAG_REPLY,
    ...
    SLINK: process.env.IG === undefined ? 'instagram.com/taurus_mp4' : process.env.IG,
    ...
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'muhammed' : process.env.AUTO_FAKE,
